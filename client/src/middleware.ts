 ...
 * 
 * Intercepts requests to /api/* endpoints and forwards them to the configured
 * API server. Non-API requests are passed through to regular Astro handling.
 * 
 * @param context - The Astro context object containing request information
 * @param next - The next middleware function in the chain
 * @returns Response from the API server or error response
 */
